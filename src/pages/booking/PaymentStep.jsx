...
export const PaymentStep = ({ nextStep, prevStep }) => {
  ...
  const { baseFare, seatTotal, taxes, grandTotal } = useFare()
  ...
  return (
    <div className="bg-[#F5F7FA]">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-16 pt-6 pb-10">
        <h2 className="text-xl md:text-2xl font-bold text-[#031e3d] mb-5">Payment</h2>
        ...
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <aside className="w-full xl:w-[400px] xl:sticky xl:top-24 self-start bg-white rounded-3xl border border-slate-200 shadow-sm p-4 sm:p-5">
            <div className="mb-5">
              <h2 className="text-xl font-bold text-[#0A2A6B]">Your booking summary</h2>
              <p className="text-slate-500 mt-1 text-xs">Review your trip details before payment</p>
            </div>

            <FlightOverview compact />

            <div className="border border-slate-200 rounded-2xl p-5 mt-5">
              <h3 className="font-bold text-[#0A2A6B] text-lg mb-4">Fare breakdown</h3>
              ...
              <div className="border-t border-slate-200 mt-4 pt-4 flex items-center justify-between">
                <h3 className="font-bold text-[#0A2A6B]">Total amount</h3>
            ...
            <div className="grid grid-cols-3 gap-3 mt-5 pt-4 border-t border-slate-200">
              {trust.map(({ icon: Icon, title, text }) => (
                <div key={title} className="text-center">
                  ...
                  <h4 className="font-semibold text-sm text-[#0A2A6B] mt-2">{title}</h4>
        ...
        <button
          onClick={prevStep}
          className="mt-6 flex items-center gap-2 text-blue-600 hover:text-blue-800 cursor-pointer"
        >
          <FaArrowLeft />
          Back to summary
        </button>
