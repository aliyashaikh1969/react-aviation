...
export const Home = () => {
    return (
        <>
            <div className="w-full h-screen bg-cover bg-center px-16 md:py-8 py-4"
                ...
                <div className='relative bg-gray-200 md:w-fit rounded-xl'>
                    ...
                    <div className='bg-white md:absolute rounded-2xl top-16 flex justify-between p-6 md:w-[90vw] w-full md:flex-row flex-col'>
                        ...
                        <span className='absolute md:left-[18rem] md:top-14 left-[50%] top-[9.3rem] border p-2 rounded-full bg-white shadow-lg text-[#06448a]'>
                            <LiaExchangeAltSolid />
                        </span>
